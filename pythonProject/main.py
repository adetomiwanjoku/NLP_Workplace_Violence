...
df1 = pd.read_csv(r'C:\Users\ChinweNjoku\PycharmProjects\pythonProject\20231010_EIRFsampleData.csv',
                  usecols=['DESCRIPTION'], encoding='latin1')
...
def preprocess_text(text):
    ...
    tokens = [wordnet_lemmatizer.lemmatize(porter_stemmer.stem(word)) for word in tokens if word.isalnum() and word not in remove_stopwords(text)]
